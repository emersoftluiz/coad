...
--
-- Host: mysql16-farm10.kinghost.net
-- Tempo de geração: 07/06/2022 às 16:04
...
CREATE TABLE IF NOT EXISTS `cidade` (
  `id` int(11) unsigned NOT NULL COMMENT 'Id da cidade',
  `nome` varchar(120) CHARACTER SET utf8 DEFAULT NULL COMMENT 'Nome da cidade',
...
--
-- Estrutura para tabela `costcenter`
--
...
--
-- Fazendo dump de dados para tabela `costcenter`
--
...
CREATE TABLE IF NOT EXISTS `estado` (
  ...
  `nome` varchar(75) CHARACTER SET utf8 DEFAULT NULL COMMENT 'Nome do estado',
  `uf` varchar(5) CHARACTER SET utf8 DEFAULT NULL COMMENT 'UF'
...
CREATE TABLE IF NOT EXISTS `request` (
  `id` int(11) unsigned NOT NULL COMMENT 'Id da Solicitação',
  `request_type_id` int(11) unsigned NOT NULL COMMENT 'Tipo de Solicitação',
  `title` varchar(80) CHARACTER SET utf8 NOT NULL COMMENT 'Título da Solicitação',
  `description` varchar(255) NOT NULL COMMENT 'Descrição da Solicitação',
  `request_data` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `client_name` varchar(80) NOT NULL COMMENT 'Nome do Cliente',
  `email` varchar(80) NOT NULL COMMENT 'Email do Cliente',
  `phone` varchar(15) NOT NULL COMMENT 'Telefone do Cliente',
  `request_status_id` int(11) unsigned NOT NULL DEFAULT '1' COMMENT 'Status da Solicitação'
...
INSERT INTO `request` (`id`, `request_type_id`, `title`, `description`, `request_data`, `client_name`, `email`, `phone`, `request_status_id`) VALUES
(40, 2, 'SolicitaÃ§Ã£o JurÃ­dica', 'SolicitaÃ§Ã£o para o a equipe jurÃ­dica', '2022-06-07 18:55:27', 'Maria', 'maria@teste.com', '44-4444-4444', 2);

-- --------------------------------------------------------

--
-- Estrutura para tabela `request_status`
--

CREATE TABLE IF NOT EXISTS `request_status` (
  `id` int(11) unsigned NOT NULL COMMENT 'Id do Status da Solicitação',
  `name` varchar(80) CHARACTER SET utf8 NOT NULL COMMENT 'Nome do Status da Solicitação'
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4;

--
-- Fazendo dump de dados para tabela `request_status`
--
...
--
-- Estrutura para tabela `request_type`
--

CREATE TABLE IF NOT EXISTS `request_type` (
  `id` int(11) unsigned NOT NULL COMMENT 'Id do Tipo de Solicitação',
  `name` varchar(80) CHARACTER SET utf8 NOT NULL COMMENT 'Nome do Tipo de Solicitação'
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4;

--
-- Fazendo dump de dados para tabela `request_type`
--
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `estado` int(11) NOT NULL COMMENT 'Estado do usuário',
  `cidade` int(11) unsigned NOT NULL COMMENT 'Cidade do usuário',
...
(54, 20, 21, 22, 'JosÃ© da Silva', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'jose@teste.com', 'Rua A', '', 'SÃ£o Martins', '13.222-222', 19, 3609, '11-1111-1111', '22-2222-2222', '33-33333-3333', '44-44444-4444', 'ObservaÃ§Ãµes');
...
ALTER TABLE `department`
  ADD PRIMARY KEY (`id`), ADD KEY `costcenter_id` (`costcenter_id`);
...
--
ALTER TABLE `request`
  ADD PRIMARY KEY (`id`), ADD KEY `costcenter_id` (`request_type_id`), ADD KEY `request_status_id` (`request_status_id`);

--
-- Índices de tabela `request_status`
--
ALTER TABLE `request_status`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `name` (`name`);

--
-- Índices de tabela `request_type`
--
...
--
ALTER TABLE `user`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `email` (`email`), ADD KEY `position_id` (`position_id`), ADD KEY `department_id` (`department_id`), ADD KEY `costcenter_id` (`costcenter_id`), ADD KEY `cidade` (`cidade`), ADD KEY `estado` (`estado`);
...
--
ALTER TABLE `cidade`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id da cidade',AUTO_INCREMENT=5565;
--
...
--
ALTER TABLE `request`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id da Solicitação',AUTO_INCREMENT=41;
--
-- AUTO_INCREMENT de tabela `request_status`
--
ALTER TABLE `request_status`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id do Status da Solicitação',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de tabela `request_type`
--
ALTER TABLE `request_type`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id do Tipo de Solicitação',AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT de tabela `user`
--
ALTER TABLE `user`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID do usuário',AUTO_INCREMENT=55;
--
...
ADD CONSTRAINT `request_ibfk_2` FOREIGN KEY (`request_status_id`) REFERENCES `request_status` (`id`);
...
ADD CONSTRAINT `user_ibfk_4` FOREIGN KEY (`cidade`) REFERENCES `cidade` (`id`),
ADD CONSTRAINT `user_ibfk_5` FOREIGN KEY (`estado`) REFERENCES `estado` (`id`);
